...
void drawNumber2DigitColor(int number, int delayPerStep, int r, int g, int b);
...
void loop() {
    ...
    drawNumber2DigitColor(i,1000,0,128,0);     // Green
    drawNumber2DigitColor(i,1000,255,255,0);   // Yellow
    drawNumber2DigitColor(i,1000,255,0,0);     // Red
...
// Centered 2-digit draw with fade-in animation
void drawNumber2DigitColor(int number, int delayPerStep, int red, int green, int blue) {
  if (number < 0) number = 0;
  if (number > 99) number = 99;
